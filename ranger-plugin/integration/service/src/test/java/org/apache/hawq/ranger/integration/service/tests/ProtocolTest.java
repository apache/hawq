...
public class ProtocolTest extends ServiceBaseTest {
    ...
    @Test
    public void testProtocols_UserMaria_PxfProtocol_Allowed() throws Exception {
        assertTrue(hasAccess(RANGER_TEST_USER, resources, PRIVILEGES));
    }

    @Test
    public void testProtocols_UserMaria_DoesNotExistProtocol_Denied() throws Exception {
        resources.put("protocol", "doesnotexist");
        assertFalse(hasAccess(RANGER_TEST_USER, resources, PRIVILEGES));
    }

    @Test
    public void testProtocols_UserBob_PxfProtocol_Denied() throws Exception {
