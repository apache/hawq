...
#ifndef DBCOMMON_SRC_DBCOMMON_LOG_ERROR_CODE_H_
#define DBCOMMON_SRC_DBCOMMON_LOG_ERROR_CODE_H_
...
#define ERRCODE_FILE_LOST MAKE_SQLSTATE('5', '8', 'P', '0', '3')
#define ERRCODE_INTERCONNECT_ERROR MAKE_SQLSTATE('5', '8', 'M', '0', '1')
...
/* specific error */
#define ERRCODE_SINK_ERROR MAKE_SQLSTATE('X', 'Y', '0', '0', '0')

} /* namespace dbcommon */

#endif  // DBCOMMON_SRC_DBCOMMON_LOG_ERROR_CODE_H_
