...
* ===================
* $Log: vsub.c,v $
* Revision 1.3  2007/09/12 21:55:05  cmcdevitt
* fix a lot of incorrect format specifiers, and fix some 64-bit issues
*
* Revision 1.2  2006/05/26 18:38:52  tkordas
...
void 
vsub(char * SQLRequest, int qnum, int vnum, int flags)
{
    ...
    switch(qnum)
			{
			case 1:
				sprintf(param[1], "%lld", UnifInt((DSS_HUGE)60,(DSS_HUGE)120,(long)qnum));
				param[2][0] = '\0';
				break;
			case 2:
				sprintf(param[1], "%lld", 
			...
			case 3:
				...
				*/
				tmp_date = (int)UnifInt((DSS_HUGE)0, (DSS_HUGE)30, (long)qnum);
				strcpy(param[2], *(asc_date + tmp_date + 1155));
				param[3][0] = '\0';
				break;
			case 4:
				tmp_date = (int)UnifInt((DSS_HUGE)1,(DSS_HUGE)58,qnum);
			...
			case 5:
				...
				tmp_date = (int)UnifInt((DSS_HUGE)93,(DSS_HUGE)97,(long)qnum);
				sprintf(param[2], "19%d-01-01", tmp_date);
				param[3][0] = '\0';
				break;
			case 6:
				tmp_date = (int)UnifInt((DSS_HUGE)93,(DSS_HUGE)97,qnum);
                sprintf(param[1], "19%d-01-01", tmp_date);
				sprintf(param[2], "0.0%lld", UnifInt((DSS_HUGE)2, (DSS_HUGE)9, qnum));
				sprintf(param[3], "%lld", UnifInt((DSS_HUGE)24, (DSS_HUGE)25, (long)qnum));
				param[4][0] = '\0';
				break;
			case 7:
			...
			case 9:
				...
				break;
			case 10:
				tmp_date = (int)UnifInt((DSS_HUGE)1,(DSS_HUGE)24,qnum);
				sprintf(param[1],"19%02d-%02d-01", 
					93 + tmp_date/12, tmp_date%12 + 1);
				param[2][0] = '\0';
				break;
			...
			case 13:
				...
				break;
			case 14:
				tmp_date = (int)UnifInt((DSS_HUGE)1,(DSS_HUGE)60,qnum);
				sprintf(param[1],"19%02d-%02d-01", 
					93 + tmp_date/12, tmp_date%12 + 1);
				param[2][0] = '\0';
				break;
			case 15:
				...
				break;
			case 16:
				tmp1 = (long)UnifInt((DSS_HUGE)1, (DSS_HUGE)5, qnum); 
				tmp2 = (long)UnifInt((DSS_HUGE)1, (DSS_HUGE)5, qnum);
			...
			case 17:
				...
				break;
			case 18:
				sprintf(param[1], "%lld", UnifInt((DSS_HUGE)312, (DSS_HUGE)315, qnum));
				param[2][0] = '\0';
				break;
			case 19:
				tmp1 = (long)UnifInt((DSS_HUGE)1, (DSS_HUGE)5, qnum); 
				...
				sprintf(param[4], "%lld", UnifInt((DSS_HUGE)1, (DSS_HUGE)10, qnum));
				sprintf(param[5], "%lld", UnifInt((DSS_HUGE)10, (DSS_HUGE)20, qnum));
				sprintf(param[6], "%lld", UnifInt((DSS_HUGE)20, (DSS_HUGE)30, qnum));
				param[7][0] = '\0';
				break;
			case 20:
				pick_str(&colors, qnum, param[1]);
