/*
 * $Id: rt_pg.c 10974 2013-01-15 14:56:24Z dustymugs $
 *
...
Datum RASTER_mapAlgebraFct(PG_FUNCTION_ARGS)
{
    ...
    */
    ...
    if (PG_ARGISNULL(4)) {
        ...
        cbdata.arg[k] = PointerGetDatum(NULL);
        ...
        for(y = 0; y < height; y++) {
            ...
            if (ret != -1) {
                if (FLT_EQ(r, newnodatavalue)) {
                    ...
                    cbdata.arg[0] = PointerGetDatum(NULL);
                }
                else {
...
Datum RASTER_summaryStatsCoverage(PG_FUNCTION_ARGS)
{
    ...
    #ifdef GP_VERSION
        SPIPlanPtr plan_ptr = SPI_prepare(sql, 0, NULL);
        portal = SPI_cursor_open("coverage", plan_ptr, NULL, NULL, TRUE);
    #else
			...
			if (!PG_ARGISNULL(4)) {
				...
				*/
				...
				if (!PG_ARGISNULL(7)) {
				 ...
				 ufc_info.arg[k] = PointerGetDatum(NULL);
					...
					case TEXTOID: {
						...
						/* prepared plan exists */
							...
							if (spi_argcount[i]) {
								...
								memset(values, PointerGetDatum(NULL), argkwcount);
...
Datum RASTER_mapAlgebraFctNgb(PG_FUNCTION_ARGS)
{
    ...
    */
    ...
    if (PG_ARGISNULL(7)) {
        ...
        cbdata.arg[2] = PointerGetDatum(NULL);
