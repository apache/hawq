--$Id: census_loader.sql 10716 2012-11-20 17:02:49Z robe $
--
...
IF NOT EXISTS(SELECT table_name FROM information_schema.columns WHERE table_schema = 'tiger' AND column_name = 'tract_id' AND table_name = 'tract')  THEN
	...
	COMMENT ON TABLE tiger.tract IS 'census tracts - $Id: census_loader.sql 10716 2012-11-20 17:02:49Z robe $';
	...
	COMMENT ON TABLE tiger.tabblock IS 'census blocks - $Id: census_loader.sql 10716 2012-11-20 17:02:49Z robe $';
	...
	RETURN 'Done creating census tract base tables - $Id: census_loader.sql 10716 2012-11-20 17:02:49Z robe $';
ELSE
...
${psql} -c "CREATE INDEX ${data_schema}_${state_abbrev}_${lookup_name}_the_geom_gist ON ${data_schema}.${state_abbrev}_${lookup_name} USING gist(the_geom);"
${psql} -c "vacuum analyze ${data_schema}.${state_abbrev}_${lookup_name};"', ARRAY['gid', 'uatyp10', 'uatyp']);
