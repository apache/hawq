...
CREATE TABLE public.compoundcurve (id INTEGER, description VARCHAR);
SELECT AddGeometryColumn('public', 'compoundcurve', 'the_geom_2d', 0, 'COMPOUNDCURVE', 2);
SELECT AddGeometryColumn('public', 'compoundcurve', 'the_geom_3dm', 0, 'COMPOUNDCURVEM', 3);
SELECT AddGeometryColumn('public', 'compoundcurve', 'the_geom_3dz', 0, 'COMPOUNDCURVE', 3);
SELECT AddGeometryColumn('public', 'compoundcurve', 'the_geom_4d', 0, 'COMPOUNDCURVE', 4);
