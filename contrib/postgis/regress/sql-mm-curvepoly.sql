...
CREATE TABLE public.curvepolygon (id INTEGER, description VARCHAR);
SELECT AddGeometryColumn('public', 'curvepolygon', 'the_geom_2d', 0,  'CURVEPOLYGON', 2);
SELECT AddGeometryColumn('public', 'curvepolygon', 'the_geom_3dm', 0, 'CURVEPOLYGONM', 3);
SELECT AddGeometryColumn('public', 'curvepolygon', 'the_geom_3dz', 0, 'CURVEPOLYGON', 3);
SELECT AddGeometryColumn('public', 'curvepolygon', 'the_geom_4d', 0,  'CURVEPOLYGON', 4);
