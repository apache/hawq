...
-- GPDB does not support type modifier, so use 'AddGeometryColumn'
...
CREATE TABLE public.circularstring (id INTEGER, description VARCHAR);
SELECT AddGeometryColumn('public', 'circularstring', 'the_geom_2d',  0, 'CIRCULARSTRING',   2);
SELECT AddGeometryColumn('public', 'circularstring', 'the_geom_3dm', 0, 'CIRCULARSTRINGM',  3);
SELECT AddGeometryColumn('public', 'circularstring', 'the_geom_3dz', 0, 'CIRCULARSTRING',  3);
SELECT AddGeometryColumn('public', 'circularstring', 'the_geom_4d',  0, 'CIRCULARSTRING',  4);
