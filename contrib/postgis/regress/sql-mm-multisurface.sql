...
CREATE TABLE public.multisurface (id INTEGER, description VARCHAR);
SELECT AddGeometryColumn('public', 'multisurface', 'the_geom_2d', 0, 'MULTISURFACE', 2);
SELECT AddGeometryColumn('public', 'multisurface', 'the_geom_3dm', 0, 'MULTISURFACEM', 3);
SELECT AddGeometryColumn('public', 'multisurface', 'the_geom_3dz', 0, 'MULTISURFACE', 3);
SELECT AddGeometryColumn('public', 'multisurface', 'the_geom_4d', 0, 'MULTISURFACE', 4);
