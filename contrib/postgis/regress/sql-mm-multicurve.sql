...
CREATE TABLE public.multicurve (id INTEGER, description VARCHAR);
SELECT AddGeometryColumn('public', 'multicurve', 'the_geom_2d', 0, 'MULTICURVE', 2);
SELECT AddGeometryColumn('public', 'multicurve', 'the_geom_3dm', 0, 'MULTICURVEM', 3);
SELECT AddGeometryColumn('public', 'multicurve', 'the_geom_3dz', 0, 'MULTICURVE', 3);
SELECT AddGeometryColumn('public', 'multicurve', 'the_geom_4d', 0, 'MULTICURVE', 4);
