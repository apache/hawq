...
import com.pivotal.pxf.core.format.GPDBWritableMapper;
...
public class StringPassResolverTest {
    ...
    public void testSetFields() throws Exception {
        ...
        record = inputBuilder.makeOutput(inputStream);
    ...
    private StringPassResolver buildResolver(boolean hasWarn)
        ...
        PowerMockito.when(inputData.outputFormat()).thenReturn(OutputFormat.FORMAT_TEXT);
