...
import com.pivotal.pxf.filtering.FilterParser.IFilterBuilder;
import com.pivotal.pxf.filtering.FilterParser.Operation;

@RunWith(PowerMockRunner.class)
@PrepareForTest({IFilterBuilder.class})
public class FilterParserTest {

	FilterParser.IFilterBuilder filterBuilder;
	...
	{
		filterBuilder = mock(FilterParser.IFilterBuilder.class);
	...
	public void parseNegativeNull() {
		...
		filter = null;	
		runParseNegative("null string", filter, "filter parsing ended with no result");
	}
