...
import com.pxf.infra.utils.fileformats.IFileReader;

public class CustomrAvroInSequenceReader implements IFileReader {

	private String schemaName;

	public CustomrAvroInSequenceReader(String schemaName) {
	...
	public Object[] prepareData(int rows, Table dataTable) throws Exception {
		...
		CustomAvroRecInSequence[] data = new CustomAvroRecInSequence[rows];
