...
/**
 * Parse filter object generated by {@link org.apache.hawq.pxf.plugins.jdbc.JdbcFilterBuilder} and build WHERE statement
...
public class WhereSQLBuilder extends JdbcFilterBuilder {
     ...
     * @param returnList List of {@link BasicFilter} to append filters to. Should be null if the function is not called recursively
     */
