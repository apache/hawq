...
public class FragmenterUserDataException extends Exception {
    ...
    public FragmenterUserDataException(Throwable cause) {
        super(cause);
    }

    public FragmenterUserDataException(String message) {
        super(message);
    }

    public FragmenterUserDataException(String message, Throwable cause) {
        super(message, cause);
    }
}
