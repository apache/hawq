...
TEST_F(TestVexecutor, scanframework)
{
	...
	util.execSQLFile("vexecutor/sql/create_type.sql",
					 "vexecutor/ans/create_type_scanframework.ans");
...
TEST_F(TestVexecutor, scanAO)
{
	...
	util.execute(cmd);
	util.execSQLFile("vexecutor/sql/create_type.sql",
					 "vexecutor/ans/create_type_scanao.ans");
...
TEST_F(TestVexecutor, ProjAndQual)
{
	...
	util.execSQLFile("vexecutor/sql/create_type.sql",
					 "vexecutor/ans/create_type_projandqual.ans");
...
TEST_F(TestVexecutor, vagg)
{
	...
	util.execute("insert into test_int2 select generate_series(1,10240),1,2");
	util.execute("insert into test_int4 select generate_series(1,10240),1,2");
	util.execute("insert into test_int8 select generate_series(1,10240),1,2");
	util.execute("insert into test_float4 select generate_series(1,10240),1,2");
	util.execute("insert into test_float8 select generate_series(1,10240),1,2");
	...
	// run sql file to get ans file and then diff it with out file
	util.execSQLFile("vexecutor/sql/create_type.sql",
					 "vexecutor/ans/create_type_vagg.ans");
