...
/* TIDYCAT_BEGINDEF
   ...
   create unique index on pg_resqueue(name) with (indexid=6028);
...
{
	NameData	name;					/* name of resource queue */
...
#define Anum_pg_resqueue_name					1
...
#define PG_RESQUEUE_COL_NAME							"name"
