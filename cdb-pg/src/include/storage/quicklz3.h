...
/*
 * GPDB: Force to compression level 1 for quicklz1.h, and force it to 3 for quicklz3.h,
 * because we want to compile both level 1 and level 3 into the same application, which
 * is unusual for quicklz
 */
...
#define QLZ3_POINTERS 1
#define QLZ_HASH_VALUES 4096
#elif QLZ_COMPRESSION_LEVEL == 2
#define QLZ3_POINTERS 4
#define QLZ_HASH_VALUES 2048
#elif QLZ_COMPRESSION_LEVEL == 3
#define QLZ3_POINTERS 16
#define QLZ_HASH_VALUES 4096
#endif
...
#endif
#else
	const unsigned char *offset[QLZ3_POINTERS];
#endif
...
typedef struct
{
	...
	qlz3_hash_compress hash[QLZ_HASH_VALUES];
	...
	typedef struct
	{
		...
		unsigned char stream_buffer[QLZ_STREAMING_BUFFER];
#endif
		qlz3_hash_decompress hash[QLZ_HASH_VALUES];
		unsigned char hash_counter[QLZ_HASH_VALUES];
		size_t stream_counter;
	} qlz3_state_decompress;
#elif QLZ_COMPRESSION_LEVEL == 3
	typedef struct
	{
#if QLZ_STREAMING_BUFFER > 0
