...
#define QLZ1_POINTERS 1
#define QLZ_HASH_VALUES 4096
#elif QLZ_COMPRESSION_LEVEL == 2
#define QLZ1_POINTERS 4
#define QLZ_HASH_VALUES 2048
#elif QLZ_COMPRESSION_LEVEL == 3
#define QLZ1_POINTERS 16
#define QLZ_HASH_VALUES 4096
#endif
...
#endif
#else
	const unsigned char *offset[QLZ1_POINTERS];
#endif
...
typedef struct
{
	...
	qlz1_hash_compress hash[QLZ_HASH_VALUES];
	...
	typedef struct
	{
		...
		unsigned char stream_buffer[QLZ_STREAMING_BUFFER];
#endif
		qlz1_hash_decompress hash[QLZ_HASH_VALUES];
		unsigned char hash_counter[QLZ_HASH_VALUES];
		size_t stream_counter;
	} qlz1_state_decompress;
#elif QLZ_COMPRESSION_LEVEL == 3
	typedef struct
	{
#if QLZ_STREAMING_BUFFER > 0
