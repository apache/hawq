...
# Generated by sleazy.pl version 3 (release Tue Jun 21 13:59:30 2011)
...
=head1 VERSION
 ...
 This document describes version 4 of sleazy.pl, released
 Fri Jul  8 15:26:54 2011.
...
BEGIN {
	...
	$glob_glob->{_sleazy_properties}->{version} = '4';
	$glob_glob->{_sleazy_properties}->{slzy_date} = '1310164014';
...
my $validate_filestr = 
	...
	'|unless (defined($s_{ARGNAME}) && (-e $s_{ARGNAME}));';
