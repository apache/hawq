...
=head1 VERSION
 ...
 This document describes version 54 of calico.pl, released
 Fri Dec 14 14:24:12 2012.
...
Copyright (c) 2012 Reddy, Radhika.  All rights reserved.  

Address bug reports and comments to: reddyr3
...
BEGIN {
	...
	$glob_glob->{_sleazy_properties}->{version} = '54';
	$glob_glob->{_sleazy_properties}->{slzy_date} = '1355523852';
