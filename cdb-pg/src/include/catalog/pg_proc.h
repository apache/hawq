...
DATA(insert OID = 6071 ( pg_stat_get_activity  PGNSP PGUID 12 f f f t v 1 2249 f "23" "{23,26,23,26,25,25,16,1184,1184,1184,869,23,23}" "{i,o,o,o,o,o,o,o,o,o,o,o,o}" "{pid,datid,procpid,usesysid,application_name,current_query,waiting,xact_start,query_start,backend_start,client_addr,client_port,sess_id}" pg_stat_get_activity - _null_ n ));
