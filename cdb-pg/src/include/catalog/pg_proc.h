...
DATA(insert OID = 6071 ( pg_stat_get_activity  PGNSP PGUID 12 f f f t s 1 2249 f "23" "{23,26,23,26,25,25,16,1184,1184,1184,869,23,23}" "{i,o,o,o,o,o,o,o,o,o,o,o,o}" "{pid,datid,procpid,usesysid,application_name,current_query,waiting,xact_start,query_start,backend_start,client_addr,client_port,sess_id}" pg_stat_get_activity - _null_ n ));
...
DATA(insert OID = 6084 ( gp_partition_selection  PGNSP PGUID 12 f f t f v 2 26 f "26 2283" _null_ _null_ _null_ gp_partition_selection - _null_ n ));
DESCR("selects the child partition oid which satisfies a given partition key value");

/* gp_partition_expansion(oid) => setof oid */ 
DATA(insert OID = 6085 ( gp_partition_expansion  PGNSP PGUID 12 f f t t v 1 26 f "26" _null_ _null_ _null_ gp_partition_expansion - _null_ n ));
DESCR("finds all child partition oids for the given parent oid");

/* gp_partition_inverse(oid) => setof record */ 
DATA(insert OID = 6086 ( gp_partition_inverse  PGNSP PGUID 12 f f t t v 1 2249 f "26" _null_ _null_ _null_ gp_partition_inverse - _null_ n ));
