...
DROP SCHEMA IF EXISTS madlib_install_check_gpsql_chi2_test CASCADE;
CREATE SCHEMA madlib_install_check_gpsql_chi2_test;
SET search_path = madlib_install_check_gpsql_chi2_test, madlib;
...
DROP SCHEMA madlib_install_check_gpsql_chi2_test CASCADE;
