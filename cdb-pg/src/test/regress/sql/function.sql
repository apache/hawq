...
-- DDL, CREATE FUNCTION, SRF, NEGATIVE
...
-- DDL, CREATE FUNCTION, SECURITY DEFINER, NEGATIVE
...
-- DDL, ALTER FUNCTION, SECURITY DEFINER, NEGATIVE
CREATE FUNCTION g(int) RETURNS INTEGER AS 'SELECT 1' LANGUAGE SQL IMMUTABLE;
...
-- DML, InitPlan
SELECT UNNEST(ARRAY(SELECT x FROM foo));
