...
-- function over table (executed on segments)
--    Fails: record + motion and plperl does not support SFRM_Materialize
select foor(fooid), * from foo2;
...
-- function over table (executed on segments)
--    Fails: can't serialize record
select fooro(fooid), * from foo2;
