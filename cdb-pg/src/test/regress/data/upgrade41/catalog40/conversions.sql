-- Conversions defined in the 4.0 Catalog:
--
-- This is based on Release-4_0-branch/cdb-pg/src/backend/utils/mb/conversion_procs/conversion_create.sql
...
CREATE DEFAULT CONVERSION upg_catalog.ascii_to_mic FOR 'SQL_ASCII' TO 'MULE_INTERNAL' FROM ascii_to_mic;
COMMENT ON CONVERSION upg_catalog.ascii_to_mic IS 'conversion for SQL_ASCII to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_ascii FOR 'MULE_INTERNAL' TO 'SQL_ASCII' FROM mic_to_ascii;
COMMENT ON CONVERSION upg_catalog.mic_to_ascii IS 'conversion for MULE_INTERNAL to SQL_ASCII';
-- KOI8R --> MULE_INTERNAL
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_r_to_mic FOR 'KOI8R' TO 'MULE_INTERNAL' FROM koi8r_to_mic;
COMMENT ON CONVERSION upg_catalog.koi8_r_to_mic IS 'conversion for KOI8R to MULE_INTERNAL';
-- MULE_INTERNAL --> KOI8R
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_koi8_r FOR 'MULE_INTERNAL' TO 'KOI8R' FROM mic_to_koi8r;
COMMENT ON CONVERSION upg_catalog.mic_to_koi8_r IS 'conversion for MULE_INTERNAL to KOI8R';
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_5_to_mic FOR 'ISO-8859-5' TO 'MULE_INTERNAL' FROM iso_to_mic;
COMMENT ON CONVERSION upg_catalog.iso_8859_5_to_mic IS 'conversion for ISO-8859-5 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_iso_8859_5 FOR 'MULE_INTERNAL' TO 'ISO-8859-5' FROM mic_to_iso;
COMMENT ON CONVERSION upg_catalog.mic_to_iso_8859_5 IS 'conversion for MULE_INTERNAL to ISO-8859-5';
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1251_to_mic FOR 'WIN1251' TO 'MULE_INTERNAL' FROM win1251_to_mic;
COMMENT ON CONVERSION upg_catalog.windows_1251_to_mic IS 'conversion for WIN1251 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_windows_1251 FOR 'MULE_INTERNAL' TO 'WIN1251' FROM mic_to_win1251;
COMMENT ON CONVERSION upg_catalog.mic_to_windows_1251 IS 'conversion for MULE_INTERNAL to WIN1251';
...
CREATE DEFAULT CONVERSION upg_catalog.windows_866_to_mic FOR 'WIN866' TO 'MULE_INTERNAL' FROM win866_to_mic;
COMMENT ON CONVERSION upg_catalog.windows_866_to_mic IS 'conversion for WIN866 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_windows_866 FOR 'MULE_INTERNAL' TO 'WIN866' FROM mic_to_win866;
COMMENT ON CONVERSION upg_catalog.mic_to_windows_866 IS 'conversion for MULE_INTERNAL to WIN866';
-- KOI8R --> WIN1251
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_r_to_windows_1251 FOR 'KOI8R' TO 'WIN1251' FROM koi8r_to_win1251;
COMMENT ON CONVERSION upg_catalog.koi8_r_to_windows_1251 IS 'conversion for KOI8R to WIN1251';
-- WIN1251 --> KOI8R
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1251_to_koi8_r FOR 'WIN1251' TO 'KOI8R' FROM win1251_to_koi8r;
COMMENT ON CONVERSION upg_catalog.windows_1251_to_koi8_r IS 'conversion for WIN1251 to KOI8R';
-- KOI8R --> WIN866
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_r_to_windows_866 FOR 'KOI8R' TO 'WIN866' FROM koi8r_to_win866;
COMMENT ON CONVERSION upg_catalog.koi8_r_to_windows_866 IS 'conversion for KOI8R to WIN866';
-- WIN866 --> KOI8R
...
CREATE DEFAULT CONVERSION upg_catalog.windows_866_to_koi8_r FOR 'WIN866' TO 'KOI8R' FROM win866_to_koi8r;
COMMENT ON CONVERSION upg_catalog.windows_866_to_koi8_r IS 'conversion for WIN866 to KOI8R';
-- WIN866 --> WIN1251
...
CREATE DEFAULT CONVERSION upg_catalog.windows_866_to_windows_1251 FOR 'WIN866' TO 'WIN1251' FROM win866_to_win1251;
COMMENT ON CONVERSION upg_catalog.windows_866_to_windows_1251 IS 'conversion for WIN866 to WIN1251';
-- WIN1251 --> WIN866
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1251_to_windows_866 FOR 'WIN1251' TO 'WIN866' FROM win1251_to_win866;
COMMENT ON CONVERSION upg_catalog.windows_1251_to_windows_866 IS 'conversion for WIN1251 to WIN866';
-- ISO-8859-5 --> KOI8R
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_5_to_koi8_r FOR 'ISO-8859-5' TO 'KOI8R' FROM iso_to_koi8r;
COMMENT ON CONVERSION upg_catalog.iso_8859_5_to_koi8_r IS 'conversion for ISO-8859-5 to KOI8R';
-- KOI8R --> ISO-8859-5
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_r_to_iso_8859_5 FOR 'KOI8R' TO 'ISO-8859-5' FROM koi8r_to_iso;
COMMENT ON CONVERSION upg_catalog.koi8_r_to_iso_8859_5 IS 'conversion for KOI8R to ISO-8859-5';
-- ISO-8859-5 --> WIN1251
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_5_to_windows_1251 FOR 'ISO-8859-5' TO 'WIN1251' FROM iso_to_win1251;
COMMENT ON CONVERSION upg_catalog.iso_8859_5_to_windows_1251 IS 'conversion for ISO-8859-5 to WIN1251';
-- WIN1251 --> ISO-8859-5
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1251_to_iso_8859_5 FOR 'WIN1251' TO 'ISO-8859-5' FROM win1251_to_iso;
COMMENT ON CONVERSION upg_catalog.windows_1251_to_iso_8859_5 IS 'conversion for WIN1251 to ISO-8859-5';
-- ISO-8859-5 --> WIN866
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_5_to_windows_866 FOR 'ISO-8859-5' TO 'WIN866' FROM iso_to_win866;
COMMENT ON CONVERSION upg_catalog.iso_8859_5_to_windows_866 IS 'conversion for ISO-8859-5 to WIN866';
-- WIN866 --> ISO-8859-5
...
CREATE DEFAULT CONVERSION upg_catalog.windows_866_to_iso_8859_5 FOR 'WIN866' TO 'ISO-8859-5' FROM win866_to_iso;
COMMENT ON CONVERSION upg_catalog.windows_866_to_iso_8859_5 IS 'conversion for WIN866 to ISO-8859-5';
...
CREATE DEFAULT CONVERSION upg_catalog.euc_cn_to_mic FOR 'EUC_CN' TO 'MULE_INTERNAL' FROM euc_cn_to_mic;
COMMENT ON CONVERSION upg_catalog.euc_cn_to_mic IS 'conversion for EUC_CN to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_euc_cn FOR 'MULE_INTERNAL' TO 'EUC_CN' FROM mic_to_euc_cn;
COMMENT ON CONVERSION upg_catalog.mic_to_euc_cn IS 'conversion for MULE_INTERNAL to EUC_CN';
-- EUC_JP --> SJIS
...
CREATE DEFAULT CONVERSION upg_catalog.euc_jp_to_sjis FOR 'EUC_JP' TO 'SJIS' FROM euc_jp_to_sjis;
COMMENT ON CONVERSION upg_catalog.euc_jp_to_sjis IS 'conversion for EUC_JP to SJIS';
-- SJIS --> EUC_JP
...
CREATE DEFAULT CONVERSION upg_catalog.sjis_to_euc_jp FOR 'SJIS' TO 'EUC_JP' FROM sjis_to_euc_jp;
COMMENT ON CONVERSION upg_catalog.sjis_to_euc_jp IS 'conversion for SJIS to EUC_JP';
...
CREATE DEFAULT CONVERSION upg_catalog.euc_jp_to_mic FOR 'EUC_JP' TO 'MULE_INTERNAL' FROM euc_jp_to_mic;
COMMENT ON CONVERSION upg_catalog.euc_jp_to_mic IS 'conversion for EUC_JP to MULE_INTERNAL';
-- SJIS --> MULE_INTERNAL
...
CREATE DEFAULT CONVERSION upg_catalog.sjis_to_mic FOR 'SJIS' TO 'MULE_INTERNAL' FROM sjis_to_mic;
COMMENT ON CONVERSION upg_catalog.sjis_to_mic IS 'conversion for SJIS to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_euc_jp FOR 'MULE_INTERNAL' TO 'EUC_JP' FROM mic_to_euc_jp;
COMMENT ON CONVERSION upg_catalog.mic_to_euc_jp IS 'conversion for MULE_INTERNAL to EUC_JP';
-- MULE_INTERNAL --> SJIS
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_sjis FOR 'MULE_INTERNAL' TO 'SJIS' FROM mic_to_sjis;
COMMENT ON CONVERSION upg_catalog.mic_to_sjis IS 'conversion for MULE_INTERNAL to SJIS';
...
CREATE DEFAULT CONVERSION upg_catalog.euc_kr_to_mic FOR 'EUC_KR' TO 'MULE_INTERNAL' FROM euc_kr_to_mic;
COMMENT ON CONVERSION upg_catalog.euc_kr_to_mic IS 'conversion for EUC_KR to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_euc_kr FOR 'MULE_INTERNAL' TO 'EUC_KR' FROM mic_to_euc_kr;
COMMENT ON CONVERSION upg_catalog.mic_to_euc_kr IS 'conversion for MULE_INTERNAL to EUC_KR';
-- EUC_TW --> BIG5
...
CREATE DEFAULT CONVERSION upg_catalog.euc_tw_to_big5 FOR 'EUC_TW' TO 'BIG5' FROM euc_tw_to_big5;
COMMENT ON CONVERSION upg_catalog.euc_tw_to_big5 IS 'conversion for EUC_TW to BIG5';
-- BIG5 --> EUC_TW
...
CREATE DEFAULT CONVERSION upg_catalog.big5_to_euc_tw FOR 'BIG5' TO 'EUC_TW' FROM big5_to_euc_tw;
COMMENT ON CONVERSION upg_catalog.big5_to_euc_tw IS 'conversion for BIG5 to EUC_TW';
...
CREATE DEFAULT CONVERSION upg_catalog.euc_tw_to_mic FOR 'EUC_TW' TO 'MULE_INTERNAL' FROM euc_tw_to_mic;
COMMENT ON CONVERSION upg_catalog.euc_tw_to_mic IS 'conversion for EUC_TW to MULE_INTERNAL';
-- BIG5 --> MULE_INTERNAL
...
CREATE DEFAULT CONVERSION upg_catalog.big5_to_mic FOR 'BIG5' TO 'MULE_INTERNAL' FROM big5_to_mic;
COMMENT ON CONVERSION upg_catalog.big5_to_mic IS 'conversion for BIG5 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_euc_tw FOR 'MULE_INTERNAL' TO 'EUC_TW' FROM mic_to_euc_tw;
COMMENT ON CONVERSION upg_catalog.mic_to_euc_tw IS 'conversion for MULE_INTERNAL to EUC_TW';
-- MULE_INTERNAL --> BIG5
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_big5 FOR 'MULE_INTERNAL' TO 'BIG5' FROM mic_to_big5;
COMMENT ON CONVERSION upg_catalog.mic_to_big5 IS 'conversion for MULE_INTERNAL to BIG5';
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_2_to_mic FOR 'LATIN2' TO 'MULE_INTERNAL' FROM latin2_to_mic;
COMMENT ON CONVERSION upg_catalog.iso_8859_2_to_mic IS 'conversion for LATIN2 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_iso_8859_2 FOR 'MULE_INTERNAL' TO 'LATIN2' FROM mic_to_latin2;
COMMENT ON CONVERSION upg_catalog.mic_to_iso_8859_2 IS 'conversion for MULE_INTERNAL to LATIN2';
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1250_to_mic FOR 'WIN1250' TO 'MULE_INTERNAL' FROM win1250_to_mic;
COMMENT ON CONVERSION upg_catalog.windows_1250_to_mic IS 'conversion for WIN1250 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_windows_1250 FOR 'MULE_INTERNAL' TO 'WIN1250' FROM mic_to_win1250;
COMMENT ON CONVERSION upg_catalog.mic_to_windows_1250 IS 'conversion for MULE_INTERNAL to WIN1250';
-- LATIN2 --> WIN1250
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_2_to_windows_1250 FOR 'LATIN2' TO 'WIN1250' FROM latin2_to_win1250;
COMMENT ON CONVERSION upg_catalog.iso_8859_2_to_windows_1250 IS 'conversion for LATIN2 to WIN1250';
-- WIN1250 --> LATIN2
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1250_to_iso_8859_2 FOR 'WIN1250' TO 'LATIN2' FROM win1250_to_latin2;
COMMENT ON CONVERSION upg_catalog.windows_1250_to_iso_8859_2 IS 'conversion for WIN1250 to LATIN2';
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_1_to_mic FOR 'LATIN1' TO 'MULE_INTERNAL' FROM latin1_to_mic;
COMMENT ON CONVERSION upg_catalog.iso_8859_1_to_mic IS 'conversion for LATIN1 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_iso_8859_1 FOR 'MULE_INTERNAL' TO 'LATIN1' FROM mic_to_latin1;
COMMENT ON CONVERSION upg_catalog.mic_to_iso_8859_1 IS 'conversion for MULE_INTERNAL to LATIN1';
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_3_to_mic FOR 'LATIN3' TO 'MULE_INTERNAL' FROM latin3_to_mic;
COMMENT ON CONVERSION upg_catalog.iso_8859_3_to_mic IS 'conversion for LATIN3 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_iso_8859_3 FOR 'MULE_INTERNAL' TO 'LATIN3' FROM mic_to_latin3;
COMMENT ON CONVERSION upg_catalog.mic_to_iso_8859_3 IS 'conversion for MULE_INTERNAL to LATIN3';
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_4_to_mic FOR 'LATIN4' TO 'MULE_INTERNAL' FROM latin4_to_mic;
COMMENT ON CONVERSION upg_catalog.iso_8859_4_to_mic IS 'conversion for LATIN4 to MULE_INTERNAL';
...
CREATE DEFAULT CONVERSION upg_catalog.mic_to_iso_8859_4 FOR 'MULE_INTERNAL' TO 'LATIN4' FROM mic_to_latin4;
COMMENT ON CONVERSION upg_catalog.mic_to_iso_8859_4 IS 'conversion for MULE_INTERNAL to LATIN4';
-- SQL_ASCII --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.ascii_to_utf8 FOR 'SQL_ASCII' TO 'UTF8' FROM ascii_to_utf8;
COMMENT ON CONVERSION upg_catalog.ascii_to_utf8 IS 'conversion for SQL_ASCII to UTF8';
-- UTF8 --> SQL_ASCII
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_ascii FOR 'UTF8' TO 'SQL_ASCII' FROM utf8_to_ascii;
COMMENT ON CONVERSION upg_catalog.utf8_to_ascii IS 'conversion for UTF8 to SQL_ASCII';
-- BIG5 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.big5_to_utf8 FOR 'BIG5' TO 'UTF8' FROM big5_to_utf8;
COMMENT ON CONVERSION upg_catalog.big5_to_utf8 IS 'conversion for BIG5 to UTF8';
-- UTF8 --> BIG5
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_big5 FOR 'UTF8' TO 'BIG5' FROM utf8_to_big5;
COMMENT ON CONVERSION upg_catalog.utf8_to_big5 IS 'conversion for UTF8 to BIG5';
-- UTF8 --> KOI8R
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_koi8_r FOR 'UTF8' TO 'KOI8R' FROM utf8_to_koi8r;
COMMENT ON CONVERSION upg_catalog.utf8_to_koi8_r IS 'conversion for UTF8 to KOI8R';
-- KOI8R --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_r_to_utf8 FOR 'KOI8R' TO 'UTF8' FROM koi8r_to_utf8;
COMMENT ON CONVERSION upg_catalog.koi8_r_to_utf8 IS 'conversion for KOI8R to UTF8';
-- UTF8 --> KOI8U
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_koi8_u FOR 'UTF8' TO 'KOI8U' FROM utf8_to_koi8u;
COMMENT ON CONVERSION upg_catalog.utf8_to_koi8_u IS 'conversion for UTF8 to KOI8U';
-- KOI8U --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.koi8_u_to_utf8 FOR 'KOI8U' TO 'UTF8' FROM koi8u_to_utf8;
COMMENT ON CONVERSION upg_catalog.koi8_u_to_utf8 IS 'conversion for KOI8U to UTF8';
-- UTF8 --> WIN866
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_866 FOR 'UTF8' TO 'WIN866' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_866 IS 'conversion for UTF8 to WIN866';
-- WIN866 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.windows_866_to_utf8 FOR 'WIN866' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_866_to_utf8 IS 'conversion for WIN866 to UTF8';
-- UTF8 --> WIN874
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_874 FOR 'UTF8' TO 'WIN874' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_874 IS 'conversion for UTF8 to WIN874';
-- WIN874 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_874_to_utf8 FOR 'WIN874' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_874_to_utf8 IS 'conversion for WIN874 to UTF8';
-- UTF8 --> WIN1250
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1250 FOR 'UTF8' TO 'WIN1250' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1250 IS 'conversion for UTF8 to WIN1250';
-- WIN1250 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1250_to_utf8 FOR 'WIN1250' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1250_to_utf8 IS 'conversion for WIN1250 to UTF8';
-- UTF8 --> WIN1251
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1251 FOR 'UTF8' TO 'WIN1251' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1251 IS 'conversion for UTF8 to WIN1251';
-- WIN1251 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1251_to_utf8 FOR 'WIN1251' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1251_to_utf8 IS 'conversion for WIN1251 to UTF8';
-- UTF8 --> WIN1252
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1252 FOR 'UTF8' TO 'WIN1252' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1252 IS 'conversion for UTF8 to WIN1252';
-- WIN1252 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1252_to_utf8 FOR 'WIN1252' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1252_to_utf8 IS 'conversion for WIN1252 to UTF8';
-- UTF8 --> WIN1253
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1253 FOR 'UTF8' TO 'WIN1253' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1253 IS 'conversion for UTF8 to WIN1253';
-- WIN1253 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1253_to_utf8 FOR 'WIN1253' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1253_to_utf8 IS 'conversion for WIN1253 to UTF8';
-- UTF8 --> WIN1254
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1254 FOR 'UTF8' TO 'WIN1254' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1254 IS 'conversion for UTF8 to WIN1254';
-- WIN1254 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1254_to_utf8 FOR 'WIN1254' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1254_to_utf8 IS 'conversion for WIN1254 to UTF8';
-- UTF8 --> WIN1255
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1255 FOR 'UTF8' TO 'WIN1255' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1255 IS 'conversion for UTF8 to WIN1255';
-- WIN1255 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1255_to_utf8 FOR 'WIN1255' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1255_to_utf8 IS 'conversion for WIN1255 to UTF8';
-- UTF8 --> WIN1256
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1256 FOR 'UTF8' TO 'WIN1256' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1256 IS 'conversion for UTF8 to WIN1256';
-- WIN1256 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1256_to_utf8 FOR 'WIN1256' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1256_to_utf8 IS 'conversion for WIN1256 to UTF8';
-- UTF8 --> WIN1257
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1257 FOR 'UTF8' TO 'WIN1257' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1257 IS 'conversion for UTF8 to WIN1257';
-- WIN1257 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1257_to_utf8 FOR 'WIN1257' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1257_to_utf8 IS 'conversion for WIN1257 to UTF8';
-- UTF8 --> WIN1258
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_windows_1258 FOR 'UTF8' TO 'WIN1258' FROM utf8_to_win;
COMMENT ON CONVERSION upg_catalog.utf8_to_windows_1258 IS 'conversion for UTF8 to WIN1258';
-- WIN1258 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.windows_1258_to_utf8 FOR 'WIN1258' TO 'UTF8' FROM win_to_utf8;
COMMENT ON CONVERSION upg_catalog.windows_1258_to_utf8 IS 'conversion for WIN1258 to UTF8';
-- EUC_CN --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.euc_cn_to_utf8 FOR 'EUC_CN' TO 'UTF8' FROM euc_cn_to_utf8;
COMMENT ON CONVERSION upg_catalog.euc_cn_to_utf8 IS 'conversion for EUC_CN to UTF8';
-- UTF8 --> EUC_CN
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_euc_cn FOR 'UTF8' TO 'EUC_CN' FROM utf8_to_euc_cn;
COMMENT ON CONVERSION upg_catalog.utf8_to_euc_cn IS 'conversion for UTF8 to EUC_CN';
-- EUC_JP --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.euc_jp_to_utf8 FOR 'EUC_JP' TO 'UTF8' FROM euc_jp_to_utf8;
COMMENT ON CONVERSION upg_catalog.euc_jp_to_utf8 IS 'conversion for EUC_JP to UTF8';
-- UTF8 --> EUC_JP
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_euc_jp FOR 'UTF8' TO 'EUC_JP' FROM utf8_to_euc_jp;
COMMENT ON CONVERSION upg_catalog.utf8_to_euc_jp IS 'conversion for UTF8 to EUC_JP';
-- EUC_KR --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.euc_kr_to_utf8 FOR 'EUC_KR' TO 'UTF8' FROM euc_kr_to_utf8;
COMMENT ON CONVERSION upg_catalog.euc_kr_to_utf8 IS 'conversion for EUC_KR to UTF8';
-- UTF8 --> EUC_KR
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_euc_kr FOR 'UTF8' TO 'EUC_KR' FROM utf8_to_euc_kr;
COMMENT ON CONVERSION upg_catalog.utf8_to_euc_kr IS 'conversion for UTF8 to EUC_KR';
-- EUC_TW --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.euc_tw_to_utf8 FOR 'EUC_TW' TO 'UTF8' FROM euc_tw_to_utf8;
COMMENT ON CONVERSION upg_catalog.euc_tw_to_utf8 IS 'conversion for EUC_TW to UTF8';
-- UTF8 --> EUC_TW
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_euc_tw FOR 'UTF8' TO 'EUC_TW' FROM utf8_to_euc_tw;
COMMENT ON CONVERSION upg_catalog.utf8_to_euc_tw IS 'conversion for UTF8 to EUC_TW';
-- GB18030 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.gb18030_to_utf8 FOR 'GB18030' TO 'UTF8' FROM gb18030_to_utf8;
COMMENT ON CONVERSION upg_catalog.gb18030_to_utf8 IS 'conversion for GB18030 to UTF8';
-- UTF8 --> GB18030
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_gb18030 FOR 'UTF8' TO 'GB18030' FROM utf8_to_gb18030;
COMMENT ON CONVERSION upg_catalog.utf8_to_gb18030 IS 'conversion for UTF8 to GB18030';
-- GBK --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.gbk_to_utf8 FOR 'GBK' TO 'UTF8' FROM gbk_to_utf8;
COMMENT ON CONVERSION upg_catalog.gbk_to_utf8 IS 'conversion for GBK to UTF8';
-- UTF8 --> GBK
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_gbk FOR 'UTF8' TO 'GBK' FROM utf8_to_gbk;
COMMENT ON CONVERSION upg_catalog.utf8_to_gbk IS 'conversion for UTF8 to GBK';
-- UTF8 --> LATIN2
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_2 FOR 'UTF8' TO 'LATIN2' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_2 IS 'conversion for UTF8 to LATIN2';
-- LATIN2 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_2_to_utf8 FOR 'LATIN2' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_2_to_utf8 IS 'conversion for LATIN2 to UTF8';
-- UTF8 --> LATIN3
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_3 FOR 'UTF8' TO 'LATIN3' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_3 IS 'conversion for UTF8 to LATIN3';
-- LATIN3 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_3_to_utf8 FOR 'LATIN3' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_3_to_utf8 IS 'conversion for LATIN3 to UTF8';
-- UTF8 --> LATIN4
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_4 FOR 'UTF8' TO 'LATIN4' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_4 IS 'conversion for UTF8 to LATIN4';
-- LATIN4 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_4_to_utf8 FOR 'LATIN4' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_4_to_utf8 IS 'conversion for LATIN4 to UTF8';
-- UTF8 --> LATIN5
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_9 FOR 'UTF8' TO 'LATIN5' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_9 IS 'conversion for UTF8 to LATIN5';
-- LATIN5 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_9_to_utf8 FOR 'LATIN5' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_9_to_utf8 IS 'conversion for LATIN5 to UTF8';
-- UTF8 --> LATIN6
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_10 FOR 'UTF8' TO 'LATIN6' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_10 IS 'conversion for UTF8 to LATIN6';
-- LATIN6 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_10_to_utf8 FOR 'LATIN6' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_10_to_utf8 IS 'conversion for LATIN6 to UTF8';
-- UTF8 --> LATIN7
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_13 FOR 'UTF8' TO 'LATIN7' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_13 IS 'conversion for UTF8 to LATIN7';
-- LATIN7 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_13_to_utf8 FOR 'LATIN7' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_13_to_utf8 IS 'conversion for LATIN7 to UTF8';
-- UTF8 --> LATIN8
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_14 FOR 'UTF8' TO 'LATIN8' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_14 IS 'conversion for UTF8 to LATIN8';
-- LATIN8 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_14_to_utf8 FOR 'LATIN8' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_14_to_utf8 IS 'conversion for LATIN8 to UTF8';
-- UTF8 --> LATIN9
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_15 FOR 'UTF8' TO 'LATIN9' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_15 IS 'conversion for UTF8 to LATIN9';
-- LATIN9 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_15_to_utf8 FOR 'LATIN9' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_15_to_utf8 IS 'conversion for LATIN9 to UTF8';
-- UTF8 --> LATIN10
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_16 FOR 'UTF8' TO 'LATIN10' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_16 IS 'conversion for UTF8 to LATIN10';
-- LATIN10 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_16_to_utf8 FOR 'LATIN10' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_16_to_utf8 IS 'conversion for LATIN10 to UTF8';
-- UTF8 --> ISO-8859-5
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_5 FOR 'UTF8' TO 'ISO-8859-5' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_5 IS 'conversion for UTF8 to ISO-8859-5';
-- ISO-8859-5 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_5_to_utf8 FOR 'ISO-8859-5' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_5_to_utf8 IS 'conversion for ISO-8859-5 to UTF8';
-- UTF8 --> ISO-8859-6
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_6 FOR 'UTF8' TO 'ISO-8859-6' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_6 IS 'conversion for UTF8 to ISO-8859-6';
-- ISO-8859-6 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_6_to_utf8 FOR 'ISO-8859-6' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_6_to_utf8 IS 'conversion for ISO-8859-6 to UTF8';
-- UTF8 --> ISO-8859-7
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_7 FOR 'UTF8' TO 'ISO-8859-7' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_7 IS 'conversion for UTF8 to ISO-8859-7';
-- ISO-8859-7 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_7_to_utf8 FOR 'ISO-8859-7' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_7_to_utf8 IS 'conversion for ISO-8859-7 to UTF8';
-- UTF8 --> ISO-8859-8
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_8 FOR 'UTF8' TO 'ISO-8859-8' FROM utf8_to_iso8859;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_8 IS 'conversion for UTF8 to ISO-8859-8';
-- ISO-8859-8 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_8_to_utf8 FOR 'ISO-8859-8' TO 'UTF8' FROM iso8859_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_8_to_utf8 IS 'conversion for ISO-8859-8 to UTF8';
-- LATIN1 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.iso_8859_1_to_utf8 FOR 'LATIN1' TO 'UTF8' FROM iso8859_1_to_utf8;
COMMENT ON CONVERSION upg_catalog.iso_8859_1_to_utf8 IS 'conversion for LATIN1 to UTF8';
-- UTF8 --> LATIN1
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_iso_8859_1 FOR 'UTF8' TO 'LATIN1' FROM utf8_to_iso8859_1;
COMMENT ON CONVERSION upg_catalog.utf8_to_iso_8859_1 IS 'conversion for UTF8 to LATIN1';
-- JOHAB --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.johab_to_utf8 FOR 'JOHAB' TO 'UTF8' FROM johab_to_utf8;
COMMENT ON CONVERSION upg_catalog.johab_to_utf8 IS 'conversion for JOHAB to UTF8';
-- UTF8 --> JOHAB
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_johab FOR 'UTF8' TO 'JOHAB' FROM utf8_to_johab;
COMMENT ON CONVERSION upg_catalog.utf8_to_johab IS 'conversion for UTF8 to JOHAB';
-- SJIS --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.sjis_to_utf8 FOR 'SJIS' TO 'UTF8' FROM sjis_to_utf8;
COMMENT ON CONVERSION upg_catalog.sjis_to_utf8 IS 'conversion for SJIS to UTF8';
-- UTF8 --> SJIS
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_sjis FOR 'UTF8' TO 'SJIS' FROM utf8_to_sjis;
COMMENT ON CONVERSION upg_catalog.utf8_to_sjis IS 'conversion for UTF8 to SJIS';
-- UHC --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.uhc_to_utf8 FOR 'UHC' TO 'UTF8' FROM uhc_to_utf8;
COMMENT ON CONVERSION upg_catalog.uhc_to_utf8 IS 'conversion for UHC to UTF8';
-- UTF8 --> UHC
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_uhc FOR 'UTF8' TO 'UHC' FROM utf8_to_uhc;
COMMENT ON CONVERSION upg_catalog.utf8_to_uhc IS 'conversion for UTF8 to UHC';
-- EUC_JIS_2004 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.euc_jis_2004_to_utf8 FOR 'EUC_JIS_2004' TO 'UTF8' FROM euc_jis_2004_to_utf8;
COMMENT ON CONVERSION upg_catalog.euc_jis_2004_to_utf8 IS 'conversion for EUC_JIS_2004 to UTF8';
-- UTF8 --> EUC_JIS_2004
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_euc_jis_2004 FOR 'UTF8' TO 'EUC_JIS_2004' FROM utf8_to_euc_jis_2004;
COMMENT ON CONVERSION upg_catalog.utf8_to_euc_jis_2004 IS 'conversion for UTF8 to EUC_JIS_2004';
-- SHIFT_JIS_2004 --> UTF8
...
CREATE DEFAULT CONVERSION upg_catalog.shift_jis_2004_to_utf8 FOR 'SHIFT_JIS_2004' TO 'UTF8' FROM shift_jis_2004_to_utf8;
COMMENT ON CONVERSION upg_catalog.shift_jis_2004_to_utf8 IS 'conversion for SHIFT_JIS_2004 to UTF8';
-- UTF8 --> SHIFT_JIS_2004
...
CREATE DEFAULT CONVERSION upg_catalog.utf8_to_shift_jis_2004 FOR 'UTF8' TO 'SHIFT_JIS_2004' FROM utf8_to_shift_jis_2004;
COMMENT ON CONVERSION upg_catalog.utf8_to_shift_jis_2004 IS 'conversion for UTF8 to SHIFT_JIS_2004';
...
CREATE DEFAULT CONVERSION upg_catalog.euc_jis_2004_to_shift_jis_2004 FOR 'EUC_JIS_2004' TO 'SHIFT_JIS_2004' FROM euc_jis_2004_to_shift_jis_2004;
COMMENT ON CONVERSION upg_catalog.euc_jis_2004_to_shift_jis_2004 IS 'conversion for EUC_JIS_2004 to SHIFT_JIS_2004';
...
CREATE DEFAULT CONVERSION upg_catalog.shift_jis_2004_to_euc_jis_2004 FOR 'SHIFT_JIS_2004' TO 'EUC_JIS_2004' FROM shift_jis_2004_to_euc_jis_2004;
COMMENT ON CONVERSION upg_catalog.shift_jis_2004_to_euc_jis_2004 IS 'conversion for SHIFT_JIS_2004 to EUC_JIS_2004';
