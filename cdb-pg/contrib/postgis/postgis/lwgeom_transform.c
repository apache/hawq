/**********************************************************************
 * $Id: lwgeom_transform.c 4168 2009-06-11 16:44:03Z pramsey $
 *
...
#ifdef GP_VERSION
static void PROJ4SRSCacheStats(MemoryContext context, const char* contextName);
#else
...
static void
#ifdef GP_VERSION
PROJ4SRSCacheStats(MemoryContext context, const char* contextName)
#else
