/**********************************************************************
 * $Id: lwgeom_geos_prepared.c 4168 2009-06-11 16:44:03Z pramsey $
 *
...
#ifdef GP_VERSION
static void PreparedCacheStats(MemoryContext context, const char* contextName);
#else
...
static void
#ifdef GP_VERSION
PreparedCacheStats(MemoryContext context, const char* contextName)
#else
